...
export const PREGNANCY_STAGES = {
    ...
    18: { size: "Болгарский перец", weight: "Около 190 г", belly: "Отчетливо виден под одеждой", desc: "Шемеления плода становятся регулярными и отчетливыми для всех. Сформировались фаланги пальцев. Матка продолжает активно увеличиваться в размерах." },
