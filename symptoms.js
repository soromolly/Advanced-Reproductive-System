...
export const PREGNANCY_STAGES = {
    1: { size: "Размер клетки", weight: "Менее 0.01 г", belly: "Живот незаметен", desc: "1-я акушерская неделя. Фактической беременности еще нет, идет менструация. Организм только готовится к созреванию новой яйцеклетки." },
    2: { size: "Размер клетки", weight: "Менее 0.01 г", belly: "Живот незаметен", desc: "2-я акушерская неделя. Период овуляции. Происходит выход яйцеклетки и слияние со сперматозоидом. Оплодотворенная клетка начинает деление." },
    ...
    4: { size: "Маковое зёрнышко", weight: "Менее 0.1 г", belly: "Живот незаметен", desc: "Эмбрион закрепился в маточной полости. Закладываются три зародышевых листка для будущих органов. Появляется обостренное обоняние." },
    ...
    12: { size: "Крупная слива", weight: "Около 15 г", belly: "Едва уловимая округлость", desc: "Конец 1-го triместра. Органы сформированы, плод начинает шевелиться, но это еще не чувствуется." },
    ...
    16: { size: "Крупный авокадо", weight: "Около 100 г", belly: "Заметный округлый животик", desc: "Мышцы лица развиты: плод может зажмуриваться и открывать рот. У повторнородящих возможны первые нежные шевеления плода («эффект бабочек»)." },
    ...
    35: { size: "Дыня канталупа", weight: "Около 2400 г", belly: "Живот натянут до предела", desc: "Малыш занаял почти всё свободное место в матке. Вместо резких пинков теперь ощущаются сильные медленные перекаты коленей и локтей под кожей." },
