...
export const PREGNANCY_STAGES = {
    ...
    12: { size: "Крупная слива", weight: "Около 15 г", belly: "Едва уловимая округлость", desc: "Конец 1-го триместра. Плод умеет сжимать кулачки, зевать и строить гримасы. Матка поднимается над областью малого таза, снижая давление на мочевой пузырь." },
