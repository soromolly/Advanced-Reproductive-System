...
export const SYMPTOMS = {
    ...
    heat_female: [
        ...
        "Обильное violent выделение естественной смазки на половых губах",
...
export const PREGNANCY_STAGES = {
    ...
    40: { size: "Большой арбуз", weight: "Около 3400 г", belly: "Максимальный размер, опущен вниз", desc: "Срок родов. Матка сильно давит на мочевой понятно, ходить и дышать тяжело. Готовность к схваткам." }
};
