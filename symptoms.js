...
export const SYMPTOMS = {
    ...
    preg_trimester_3: [
        ...
        "Легкая одышка even при медленном подъеме по лестнице",
...
export const PREGNANCY_STAGES = {
    ...
    19: { size: "Крупный mango", weight: "Около 240 г", belly: "Живот округляется вперед", desc: "Тело плода покрывается первородной жировой смазкой, защищающей кожу. Развиваются зоны головного мозга, отвечающие за осязание, вкус и зрение." },
